...
module design_1
  ...
  assign cin_0_1 = cin;
  assign sout[4:0] = xlconcat_0_dout;
  hier_0_imp_MHUNTD hier_0
       (.Dout(xlslice_0_Dout),
        .Dout1(xlslice_1_Dout),
        .Dout2(xlslice_3_Dout),
        .Dout3(xlslice_2_Dout),
        .ain(ain_1));
  hier_1_imp_JJAEZ6 hier_1
       (.Dout(xlslice_5_Dout),
        .Dout1(xlslice_6_Dout),
        .Dout2(xlslice_7_Dout),
        .Dout3(xlslice_4_Dout),
        .bin(bin_1));
...
module hier_1_imp_JJAEZ6
  ...
  assign Dout[0] = xlslice_5_Dout;
  assign Dout1[0] = xlslice_6_Dout;
  assign Dout2[0] = xlslice_7_Dout;
  assign Dout3[0] = xlslice_4_Dout;
  assign bin_1 = bin[3:0];
...
module hier_2_imp_ZHJ3IV
  ...
  assign xlslice_2_Dout = a2;
  assign xlslice_3_Dout = a;
  assign xlslice_4_Dout = b2;
  assign xlslice_5_Dout = b3;
  assign xlslice_6_Dout = b;
  assign xlslice_7_Dout = b1;
